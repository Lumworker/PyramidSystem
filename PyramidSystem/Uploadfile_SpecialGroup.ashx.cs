...
{
    /// <summary>
    /// Summary description for Uploadfile_SpecialGroup
    /// </summary>
    public class Uploadfile_SpecialGroup : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                string filePath = Path.GetFullPath(Path.Combine(webRootPath, "D:/ImgSpecialGroup/" + context.Request.Form["folderName"]));
