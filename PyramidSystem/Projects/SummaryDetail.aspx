<%@ Page Title="SummaryDetail - " Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SummaryDetail.aspx.cs" Inherits="PyramidSystem.Projects.SummaryDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-12">
        <div class='page-header'>
            ...
            <h3>Summary Detail <i class="fa fa-sitemap" aria-hidden="true"></i></h3>
        </div>
    </div>
    <%--/////////////////////////////////////--%>
    <div class="row">
        <div class="col-md-12">
            <center>
                        <table class="table table-bordered table-striped table-hover" id="TableSummaryDetail" >
    ...
    <div class="row" style="display: none">
        <div class="col-md-12">
            <center>
                        <table class="table table-bordered table-striped table-hover" id="TableSummary_Temp" >
                            <thead style="background-color: #e8e8e8">
                                <tr>
                                    <th>Company</th>
                                    <th>Group</th>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9 col-xs-8">
                                                <div class="input-group">
                                                    <input type="text" id="txtCostCenter" class="form-control" style="max-width: 100%" placeholder="Search">
                                                    <div class="input-group-btn">
                                                        <button class="btn btn-default" id="btnCostCenter" type="button" data-toggle="modal" data-backdrop="false" data-target="#ModalSearchDeptPyramid">
                                                            <i class="glyphicon glyphicon-search"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9 col-xs-8">
                                                <div class="input-group">
                                                    <span style="display:none" id="lblLocation"></span>
                                                    <input type="text" id="txtLocation" class="form-control" style="max-width: 100%" placeholder="Search">
                                                    <div class="input-group-btn">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9 col-xs-8">
                                                <input type="text" id="txtLevel" class="form-control" style="max-width: 100%" placeholder="Search">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-md-12 col-lg-12 col-sm-12" style="margin-bottom: 1em; padding-left: 0.5em;">
                        <button type="button" class="close" data-dismiss="modal" style="font-size: 2.5em;">&times;</button>
                        <h4 class="modal-title">CostCenter Search &nbsp;&nbsp;</h4>
    ...
    <div class="row" id="ModalBodyExportK2">
        <div class="col-md-12">
            <div>
                <table class="table table-bordered" id="TableExportK2">
                    <thead>
                        <tr id="theaderExportK2">
                        </tr>
                    </thead>
                    <tbody id="tbodyExportK2">
                    </tbody>
                </table>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            jQuery.extend(jQuery.fn.dataTableExt.oSort, {
                "date-uk-pre": function (a) { return ((a.split('/'))[2] + (a.split('/'))[1] + (a.split('/'))[0]) * 1; },
            ...
            function browseLocation() {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "<%= ResolveUrl("MaintainPyramid.aspx/LoadLocation") %>",
                    contentType: "application/json; charset=utf-8",
                    data: JSON.stringify(data),
                    dataType: "json",
                ...
                function ModalSearchSpcGroup(response) {
                    ...
                    if (response.d.length > 0) {
                        $.each(response.d, function (index, val) {
                            ...
                            fragment += '<tr>';
                            fragment += '<td class="Code"><a class="clickSearch"  href="javascript:void(0)" data-dismiss="modal" data-indexrows=' + number + '>' + val.Code + '</a></td>';
                            fragment += '<td class="Name"><a class="clickSearch"  href="javascript:void(0)" data-dismiss="modal" data-indexrows=' + number + '>' + val.Name + '</a></td>';
                            fragment += '</tr>';
                            number = number + 1;
                        });
                    } else {
            ...
            $("#btnSearch_S").on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "<%= ResolveUrl("SummaryDetail.aspx/LoadSummaryDetail") %>",
                    contentType: "application/json; charset=utf-8",
                    data: JSON.stringify(data),
                    dataType: "json",
                    success: ModalSearchSpcGroup,
                ...
                function ModalSearchSpcGroup(response) {
                    ...
                    if (response.d.length > 0) {
                        $.each(response.d, function (index, val) {
                            ...
                            fragment += '<td>' + val.Division + '</td>'
                            fragment += '<td>' + val.Costcerter + '</td>'
                            fragment += '<td>' + val.Level + '</td>'
                            fragment += '<td>' + val.Location + '</td>'
                    ...
                    var table = TableExport(document.getElementById('TableSummaryDetail'), {
