                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            ...
                            <span id="lblSiteRef" style="display: none"></span>
    ...
    <script>
        $(document).ready(function () {
            ...
            function browseEmpCommand() {
                ...
                var data = { Site_ref: $('#lblSiteRef').text(), Search: "" };
                ...
                function ShowAlert(response) {
                    if (response.d.length > 0) {
                        $.each(response.d, function (index, val) {
                            ...
                            if (val.MsgReturn == "Update Complete !!" && Acting == '0') {
                                var data = {
                                    emp_num: $('#txtEmp_Newbox').val()
                                }

                                $.ajax({
                                    type: "POST",
                                    async: true,
                                    url: "<%= ResolveUrl("MaintainPyramid.aspx/UpdateEmpHRPortalWithEmp") %>",
                                    contentType: "application/json; charset=utf-8",
                                    data: JSON.stringify(data),
                                    dataType: "json"
                                    //success: ShowAlert
                ...
                function ShowEditHeader(response) {
                    if (response.d.length > 0) {
                        $.each(response.d, function (index, val) {
                            ...
                            if (val.msg == "Update Complete") {
                                var data = {
                                    PyramidID:val.PyramidID
                                }

                                $.ajax({
                                    type: "POST",
                                    async: true,
                                    url: "<%= ResolveUrl("MaintainPyramid.aspx/UpdateEmpHRPortalWithPyramid") %>",
                                    contentType: "application/json; charset=utf-8",
                                    data: JSON.stringify(data),
                                    dataType: "json"
                                    //success: ShowAlert
            ...
            $("#btnSearch_S").on('click', function () {
                ...
                function showsearch(response) {
                    ...
                    if (response.d.length > 0) {
                        $.each(response.d, function (index, val) {
                            ...
                            fragment += '<td style="display:none" class="SiteRef"><a class="clickSearch" href="javascript:void(0)" data-dismiss="modal"  data-indexrows=' + number + '>' + SiteRef + '</a></td>';
                            fragment += '</tr>';
                            number = number + 1;
                        });
                    } else {
                ...
                $('#bodyTableSearchPyramid').on('click', '.clickSearch', function () {
                    ...
                    var DataCompany = $('#bodyTableSearchPyramid tr:eq(' + numindex + ') .company a').html(),
                        ...
                        SiteRef = $('#bodyTableSearchPyramid tr:eq(' + numindex + ') .SiteRef a').html()
